...
class CoursesSpider(scrapy.Spider):
    ...
    start_urls = [
        ...
        # "http://catalog.oregonstate.edu/SOCList.aspx?subjectcode=FES&termcode=201500&campus=dce&columns=bcfjk"
        "http://catalog.oregonstate.edu/SOCList.aspx?termcode=201500&campus=dce&level=all&subjectcode=OC&columns=bcfjk",
        # "http://catalog.oregonstate.edu/SOCList.aspx?termcode=201500&campus=dce&level=all&subjectcode=ALS&columns=bcfjk"
